        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-4">
              Anteres Unlimited Clothing LLC currently ships exclusively to
              Singapore. We import products directly from the United States and
              distribute them through our Singapore operations.
            </p>
            ...
            <p className="text-slate-600 mb-4">
              Free standard shipping is available for orders over $200. Express
              shipping discounts may apply for orders over $500.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-4">
              As products are imported from the United States, customers may be
              responsible for:
            </p>
            <ul className="list-disc pl-6 text-slate-600 mb-4">
            ...
            <p className="text-slate-600 mb-4">
              <strong>Note:</strong> These charges are determined by Singapore
              Customs and are not included in our product prices. We will
              provide guidance on estimated duties when possible.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 text-slate-600 mb-4">
              <li>
                Contact our customer service team at returns@anteresclothing.com
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-4">
              We offer free size exchanges within Singapore for the same item in
              a different size, subject to availability. Exchange requests must
            ...
            <p className="text-slate-600 mb-4">
              Color or style changes are processed as returns and new orders.
              The original item must be returned, and a new order placed for the
              desired item.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 mb-4">
              <li>
                Refunds processed within 5-10 business days after receiving
                returned items
              </li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 mb-4">
              ...
              <li>
                Replacement or refund provided based on investigation results
              </li>
            </ul>
          </section>
          ...
          {/* <section className="mb-8">
            ...
            <p className="text-slate-600 mb-4">
              For shipping and returns inquiries:
            </p>
